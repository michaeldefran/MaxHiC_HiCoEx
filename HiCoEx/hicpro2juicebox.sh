...
if [[ ! -z $RESFRAG ]]; then
    ...
    awk '{$4=$4!="+"; $7=$7!="+"} $2<=$5{print $4, $2, $3, 0, $7, $5, $6, 1}$5<$2{ print $7, $5, $6, 0, $4, $2, $3, 1}' $VALIDPAIRS > ${TEMP}/$$_allValidPairs.pre_juicebox_sorted_short | LANG=C sort -T ${TEMP} -k2,2d -k6,6d -S 50% --parallel=4 > ${TEMP}/$$_allValidPairs.pre_juicebox_sorted

fi

echo -e "Running Juicebox ..."
OUTPUTFILE=FINALMUSCLE.hic
...
if [[ ! -z $RESFRAG ]]; then
    ...
    java -Xmx32g -jar ${JUICERJAR} pre ${TEMP}/$$_allValidPairs.pre_juicebox_sorted_short ${OUTPUTFILE} ${GSIZE}
fi

## Clean
/bin/rm -f ${TEMP}/$$_resfrag.juicebox ${TEMP}/$$_allValidPairs.pre_juicebox_sorted_short
